 ...
 */
public class PuntoInteresDbAdapter {

    //
    // Definimos constante con el nombre de la tabla
    //
    public static final String C_TABLA = "PUNTO_INTERES" ;
    ...
    public PuntoInteresDbAdapter(Context context)
    {
        this.contexto = context;
    }

    public PuntoInteresDbAdapter abrir() throws SQLException
    {
    ...
    public ArrayList<PuntoInteres> getHipotecas(String filtro)
    {
        ArrayList<PuntoInteres> hipotecas = new ArrayList<PuntoInteres>();
